    ...
    extends SimpleOnGestureListener
{
	...
	private final static int	  ACTION_FAKE	     = -13;	     // just an
																	 // unlikely
																	 // number
	...
	public boolean onSingleTapConfirmed( MotionEvent arg0 )
	{
		...
		{ // we owe an ACTION_UP, so we fake an
			arg0.setAction( ACTION_FAKE ); // action which will be converted to
										   // an ACTION_UP later.
	...
	static public interface SimpleGestureListener
	{
