...
@Path( "/gcm-unregister" )
public class GcmUnregisterResource
{
	...
	public GcmUnregistrationResponse unregister(
		GcmUnregistrationRequest request ) {
		return DAO.unregistreGcmId( request.getGcmId() );
	}
}
