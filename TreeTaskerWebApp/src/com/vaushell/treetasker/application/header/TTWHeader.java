    ...
    extends CustomComponent
{
	...
	private HorizontalLayout buildLoginLayout()
	{
		...
		// vLNKregister
		vLNKregister = new Link();
		vLNKregister.setCaption( "S'enregistrer" );
		vLNKregister.setImmediate( false );
		vLNKregister.setWidth( "-1px" );
		vLNKregister.setHeight( "-1px" );
		loginLayout.addComponent( vLNKregister );
		loginLayout.setExpandRatio( vLNKregister, 1.0f );
		loginLayout.setComponentAlignment( vLNKregister, new Alignment( 34 ) );
